...
//获取登录地址
func (e *Outh_wb) Get_Rurl(state string) string {
...
//获取token
func (e *Outh_wb) Get_Token(code string) (*Outh_wb_succ_res, error) {
...
//获取第三方用户信息
func (e *Outh_wb) Get_User_Info(access_token string, openid string) (string, error) {
...
//构造方法
func NewOuth_wb(config *Outh_conf) *Outh_wb {
	return &Outh_wb{
		Conf: config,
	}
}
